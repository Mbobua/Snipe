  ...
  <body class="sidebar-mini skin-blue {{ (session('menu_state')!='open') ? 'sidebar-mini sidebar-collapse' : ''  }}">
    <div class="wrapper">
      ...
      <footer class="main-footer hidden-print">
        ...
        <a target="_blank" href="https://tierdata.co.ke/" rel="noopener">Tier Data Limited Assets</a> , made with <i class="fa fa-heart" style="color: #a94442; font-size: 10px"></i> by <a href="https://twitter.com/Tier_Data" rel="noopener">@Tier_Data</a>.
      </footer>
